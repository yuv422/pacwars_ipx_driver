...
Start:
    ...
    mov ax, cs
    mov ds, ax
    lea si, [checkCmd] ; ds:si = &checkCmd
    ...
    mov byte [connectionToOpen], al ; write connection number argument into check pipe command.
...
[SECTION .data]
startMsg db 'Netware check pipe.', 0x0d, 0x0a, '$'
okCommand db 'Ok it worked.', 0x0d, 0x0a, '$'
checkCmd db 4, 0, 8, 2, 1
